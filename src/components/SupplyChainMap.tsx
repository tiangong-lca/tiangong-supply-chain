        ...
        <div className="p-6 text-center">
          <div className="bg-gray-100 rounded-lg h-[280px] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center">
              <p className="text-lg font-medium text-slate-800 bg-white/80 px-4 py-2 rounded">{t('interactiveMapTitle')}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
              <span className="text-sm text-gray-500">{t('rawMaterials')}</span>
              <span className="text-xl font-semibold text-eco-green">2 Suppliers</span>
            </div>
            <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
              <span className="text-sm text-gray-500">{t('manufacturing')}</span>
              <span className="text-xl font-semibold text-eco-blue">2 Suppliers</span>
            </div>
            <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
              <span className="text-sm text-gray-500">{t('distribution')}</span>
